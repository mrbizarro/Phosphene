...
>
> Report: `~/AI/projects/phosphene/notes/v40_integration_report.md`. **Not done: step 16, FROM-ZERO** — a fresh Pinokio install rendering one clip. That gate blocks public promote and nothing substitutes for it.
