...
const SHORTCUTS = [
  ...
  { id: 'editor.split', scope: 'editor', combos: ['s', 'mod+k', 'mod+b'], owner: 'editor.js',
    calls: 'sbeSplitHere', label: 'Split the shot under the playhead (S, or ⌘K as in Premiere, ⌘B as in Final Cut and Resolve)' },
  { id: 'editor.lift', scope: 'editor', combos: ['backspace'], hidden: ['delete'], owner: 'editor.js',
    calls: 'sbeLiftSelected', label: 'Lift — take the selected clips out and leave the hole' },
  { id: 'editor.ripple', scope: 'editor', combos: ['shift+backspace'], hidden: ['shift+delete'],
    owner: 'editor.js', calls: 'sbeRippleSelected',
    label: 'Ripple delete — take them out and close the gap' },
  ...
  { id: 'editor.duplicate', scope: 'editor', combos: ['d'], owner: 'editor.js',
    calls: 'sbeDuplicateSel', label: 'Duplicate the selected clips' },
